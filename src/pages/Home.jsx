...
export const Home = () => {
  ...
  return (
    <section
      id="home"
      className="flex flex-col-reverse items-center justify-center w-screen h-screen gap-10 relative  sm:flex-row "
    >
      {/* Background Beams */}
      <motion.div
      ...
      <motion.aside
        className="w-1/2 h-full flex justify-center items-center z-10"
        initial={{ opacity: 0, x: -100 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 1 }}
      >
        <div className="flex justify-end w-full h-1/2 scale-150 md:scale-105 relative">
          <motion.img
            src={jhon}
            className="w-72 h-full object-contain grayscale-100 md:w-1/2"
            alt="Jonathan Peña"
          ...
          />
          <motion.div
            className="absolute w-4 right-20 z-20 top-0 rounded-lg md:right-[12%] bg-blue-500/50 md:w-8 h-full "
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 1 }}
          />
      ...
      <motion.article
        className="flex flex-col w-full   items-start justify-center md:w-1/2 h-full gap-4 z-10"
        initial={{ opacity: 0, x: 100 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 1 }}
      >
        <div className="flex flex-col w-full items-start justify-center gap-4 p-6 md:w-8/12 h-3/4">
          <h2 className="text-2xl w-full text-blue-500">{t('webDeveloper')}</h2>

          <h1 className="text-4xl text-gray-200 mb-2">
            {t('jpgDev')} Jonathan
            <span className="text-blue-300 border-b-2 border-blue-300 border-solid"> Peña </span>
          </h1>

          <p className="w-5/8 text-start mt-1 text-gray-200">{t('descripcion')}</p>

          <motion.button
            className="w-20 bg-blue-300 text-gray-900 rounded-lg p-1 hover:bg-blue-600"
            onClick={start}
          ...
          >
            <div className="card">
              <a
                href="https://www.instagram.com/jonathan_jjpg/"
                target="_blank"
              ...
              <a className="socialContainer containerThree"   href="https://www.linkedin.com/in/jonathanjpg"
  target="_blank">
