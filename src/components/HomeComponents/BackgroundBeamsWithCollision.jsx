...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        "h-screen md:h-[40rem] bg-black relative flex items-center w-screen justify-center overflow-hidden",
      ...
      <div
        ref={containerRef}
        className="absolute bottom-0 bg-green-700 w-full inset-x-0 pointer-events-none"
        style={{
          boxShadow:
